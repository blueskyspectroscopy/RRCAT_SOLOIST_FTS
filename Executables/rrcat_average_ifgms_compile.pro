...
pro rrcat_average_ifgms_compile

	routines=['rrcat_average_ifgms', 'SOLOIST_FTS_READ_FILE', 'WRITE_SPC']
	...
	save,/routines,filename=programrootdir()+'build\rrcat_average_ifgms.sav',/ver

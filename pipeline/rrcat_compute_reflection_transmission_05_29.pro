PRO rrcat_compute_reflection_transmission_05_29

  ;rootDir = 'U:\RRCAT\Data\2018_06_01\'
  rootDir = 'U:\RRCAT\Data\2018_06_02\'
  ...
  foreach rt, rts do begin
    foreach sample, samples do begin
      foreach det, dets do begin
        ...
        read_spc, sampleDir+sampleFileRoot+'_processed.spc', sampleWn, sampleSpec
        read_spc, refDir+refFileRoot+'_processed.spc', refWn, refSpec
        ...
        WRITE_SPC,resultsDir+'\'+outFile,sampleSpecAbs/refSpecAbs,sampleWn[0],sampleWn[1]-sampleWn[0]
        STOP
      endforeach
    endforeach
  endforeach
